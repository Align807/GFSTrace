...
export default function Spraylogs() {
  ...
  const getactivity = async () => {
    var json = {
      "paramObject": {
        ...
        "paramArray": [db.data[0].user_id, "Spraylogs"],
        "strCallerFunction": "DEMO DATA"
      }
    };
  ...
  const columns = [
    ...
    // {
    //   title:t('activities.started',"Started"), field: "started", lookup: {
    //     '0': 'No',
    //     '1': 'Yes'
    //   }
    // },
    // {
    //   title: t('activities.completed',"Completed"), field: "completed", lookup: {
    //     '0': 'No',
    //     '1': 'Yes'
    //   }
    // },
  ...
  //   setData(!selected ? spraylogsData_withcomplete : spraylogsData_withoutcomplete)
  // };
  return (
