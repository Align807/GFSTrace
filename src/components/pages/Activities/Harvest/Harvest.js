  ...
  const getactivity = async () => {
    var json = {
      "paramObject": {
        ...
        "paramArray": [db.data[0].user_id, "Harvest"],
        "strCallerFunction": "DEMO DATA"
      }
    };
...
'1': 'Yes'}
  ...
  //   setData(!selected ? harvestData_withcomplete : harvestData_withoutcomplete)
  // };
  return (
    ...
    <div className= "subheader">
        ...
        <h1 style={{"color": "black", "margin-bottom":"0px"}}><Trans i18nKey="harvest.heading">Harvest</Trans> </h1><span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
