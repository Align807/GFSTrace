...
export default function Irrigation() {
  ...
  const getactivity = async () => {
    var json = {
      "paramObject": {
        ...
        "paramArray": [db.data[0].user_id, "Irrigation"],
        "strCallerFunction": "DEMO DATA"
      }
    };
  ...
  //   setData(!selected ? irrigationData_withcomplete : irrigationData_withoutcomplete)
  // };
  return (
    <div className="table-size">
      ...
      <div className="subheader">
        ...
        <h1 style={{ "color": "black", "margin-bottom": "0px" }}><Trans i18nKey="irrigation.heading">Irrigation</Trans> </h1><span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
