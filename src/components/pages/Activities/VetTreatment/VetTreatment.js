  ...
  const getactivity = async () => {
    var json = {
      "paramObject": {
        ...
        "paramArray": [db.data[0].user_id, "VetTreatment"],
        "strCallerFunction": "DEMO DATA"
      }
    };
  ...
  const updateactivity = async (prop) => {
    ...
    var json = {
      "objJsonData": {
        ...
        "whereInObject": { "act_id": [prop.act_id] }
      },
      "arrKeyFields": ["act_id"]
    };
    console.log(json)
...
{ title:t('activities.livestock',"Livestock"), field: "livestock_type",  
...
{ title: t('activities.product',"Product"), field: "livestock_products" },
  ...
  //   setData(!selected ? vettreatmentData_withcomplete : vettreatmentData_withoutcomplete)
  // };
  return (
    ...
    <div className= "subheader">
        ...
        <h1 style={{"color": "black", "margin-bottom":"0px"}}><Trans i18nKey="vettreatment.heading">Vet Treatment</Trans> </h1><span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
