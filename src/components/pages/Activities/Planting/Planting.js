  ...
  const getactivity = async () => {
    var json = {
      "paramObject": {
        ...
        "paramArray": [db.data[0].user_id, "Planting"],
        "strCallerFunction": "DEMO DATA"
      }
    };
...
'1': 'Yes'}
  ...
  //   setData(!selected ? plantingData_withcomplete : plantingData_withoutcomplete)
  // };
  return (
    ...
    <div className= "subheader">
        ...
        <h1 style={{"color": "black", "margin-bottom":"0px"}}><Trans i18nKey="planting.heading">Planting</Trans> </h1><span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
