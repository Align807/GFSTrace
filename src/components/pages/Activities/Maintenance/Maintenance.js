...
export default function Maintenance() {
  ...
  console.log(obj);
  var obj1 = paddock.reduce(function (acc1, cur1, i) {
    acc1[cur1.paddockid] = cur1.paddock_name;
  ...
  const getactivity = async () => {
    var json = {
      "paramObject": {
        ...
        "paramArray": [db.data[0].user_id, "Paddock Maintenance"],
        "strCallerFunction": "DEMO DATA"
      }
    };
  ...
  const columns = [
    ...
    {
      title: "Paddock", field: "paddockid", lookup: obj1, validate: (rowData) => {
        if (rowData.paddockid === undefined || rowData.paddockid === "") {
          return "Required";
        }
        return true;
      },
    ...
    {
      title: t('activities.approved', "Approved"), field: "act_approved", lookup: {
        '0': 'No',
        '1': 'Yes'
      }
    ...
    {
      title: t('activities.category', "Category"), field: "paddock_maint_category",
      lookup: { '0': 'None', '1': 'Equipment', '2': 'Paddock', '3': 'Fuel Tank', '4': 'Silo', '5': 'Livestock' },
    },
    { title: t('activities.scheduleddate', "Scheduled Date"), field: "scheduled_date", type: "date", filtering: false },
  ...
  //   setData(!selected ? maintenanceData_withcomplete : maintenanceData_withoutcomplete)
  // };
  return (
    <div className="table-size">
      ...
      <div className="subheader">
        ...
        <h1 style={{ "color": "black", "margin-bottom": "0px" }}><Trans i18nKey="maintainance.heading">Paddock Maintainance</Trans> </h1><span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
